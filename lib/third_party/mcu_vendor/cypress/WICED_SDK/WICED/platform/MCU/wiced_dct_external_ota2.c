...
wiced_result_t wiced_dct_ota2_saved_copy_get_version( wiced_dct_sdk_ver_t *dct_version  )
{
    ...
    *dct_version = wiced_dct_validate_and_determine_version(OTA2_IMAGE_APP_DCT_SAVE_AREA_BASE, OTA2_IMAGE_APP_DCT_SAVE_AREA_BASE + platform_dct_copy_size, NULL, NULL);
...
wiced_result_t wiced_dct_ota2_read_saved_copy( void* info_ptr, dct_section_t section, uint32_t offset, uint32_t size )
{
    ...
    /* do standard checks to see if the DCT copy is valid */
    sdk_dct_version = wiced_dct_validate_and_determine_version(OTA2_IMAGE_APP_DCT_SAVE_AREA_BASE, OTA2_IMAGE_APP_DCT_SAVE_AREA_BASE + platform_dct_copy_size, NULL, NULL);
    ...
    if ( (sdk_dct_version != DCT_BOOTLOADER_SDK_UNKNOWN) && (sdk_dct_version > DCT_BOOTLOADER_SDK_3_5_2))
    {
        ...
        retval = sflash_read_func( &sflash_handle, curr_dct + offset, info_ptr, size );
