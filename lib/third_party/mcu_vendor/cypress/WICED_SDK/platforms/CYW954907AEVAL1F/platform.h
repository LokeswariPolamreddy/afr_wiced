...
/*
CYW954907AEVAL1F platform pin definitions ...
+--------------------------------------------------------------------------------------------------------+--------------+--------------------------------------------------+
| Enum ID       |Pin  |   Pin Name   |  SIP Pin  Name          | SIP |  Module Pin              | Module | Function     | Board Connection              | WICED Peripheral |
|               | #   |   on 43907   |                         | Pin#|  Name                    | Pin#   |              |                               | Alias            |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
...
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_3  | 95  | GPIO_7       | GPIO_7_WCPU_BOOT_MODE   | A8  | GPIO_7_WCPU_BOOT_MODE    | J10:4  |  GPIO        | ARD_GPIO3 (PWM)               | WICED_PWM_6      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_4  | 134 | GPIO_8       | GPIO_8_TAP_SEL          | C16 | GPIO_8_TAP_SEL           | xxxx   |  GPIO        | USER_2 Button                 | WICED_BUTTON1    |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_5  | 94  | GPIO_9       | GPIO_9_USB_SEL          | C15 | GPIO_9                   | J12:7  |  GPIO        | ARD_SCK/LED_2                 | WICED_LED2       |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_6  | 146 | GPIO_10      | GPIO_10                 | A45 | GPIO_10                  | J12:4  |  GPIO        | ARD_MOSI (PWM)                | WICED_PWM_0      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_7  | 140 | GPIO_11      | GPIO_11_ACPU_BOOT_MODE  | C4  | GPIO_11_ACPU_BOOT_MODE   | J12:3  |  GPIO        | ARD_SS (PWM)                  | WICED_PWM_1      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_8  | 143 | GPIO_12      | GPIO_12                 | C14 | GPIO_12                  | J12:5  |  GPIO        | ARD_MISO                      |                  |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
...
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_11 | 145 | GPIO_15      | GPIO_15                 | B26 | GPIO_15                  | J10:7  |  GPIO        | ARD_GPIO6 (PWM)               | WICED_PWM_4      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_12 | 137 | GPIO_16      | GPIO_16                 | B19 | GPIO_16                  | J10:6  |  GPIO        | ARD_GPIO5 (PWM)               | WICED_PWM_3      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
...
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_16 | 189 | PWM_3        | PWM_3                   | A26 | PWM_3                    | J6:7   |  PWM, GPIO   | TP4/LED_1                     | WICED_LED1       |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_17 | 187 | PWM_4        | PWM_4                   | A31 | PWM_4                    | J6:1   |  PWM, GPIO   | ARD_GPIO9 (PWM)               | WICED_PWM_5      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_18 | 188 | PWM_5        | PWM_5                   | D7  | PWM_5                    | J6:2   |  PWM, GPIO   | USER_1 Button                 | WICED_BUTTON1    |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_19 | 78  | SPI_0_MISO   | SPI_0_MISO              | A12 | SPI_0_MISO               | J6:17  |  SPI, GPIO   |                               | WICED_SPI_1      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_20 | 76  | SPI_0_CLK    | SPI_0_CLK               | A11 | SPI_0_CLK                | J6:12  |  SPI, GPIO   |                               | WICED_SPI_1      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_21 | 81  | SPI_0_MOSI   | SPI_0_MOSI              | A9  | SPI_0_MOSI               | J6:14  |  SPI, GPIO   |                               | WICED_SPI_1      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_22 | 82  | SPI_0_CS     | SPI_0_CS                | A10 | SPI_0_CS                 | J6:16  |  SPI, GPIO   |                               | WICED_SPI_1      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_23 | 139 | GPIO_2       | GPIO_2_JTAG_TCK         | C13 | GPIO_2_JTAG_TCK          | J3:9   |  GPIO        | DEBUGGER                      |                  |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_24 | 144 | GPIO_3       | GPIO_3_JTAG_TMS         | B20 | GPIO_3_JTAG_TMS          | J3:7   |  GPIO        | DEBUGGER                      |                  |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_25 | 136 | GPIO_4       | GPIO_4_JTAG_TDI         | C3  | GPIO_4_JTAG_TDI          | J3:3   |  GPIO        | DEBUGGER                      |                  |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_26 | 132 | GPIO_5       | GPIO_5_JTAG_TDO         | B4  | GPIO_5_JTAG_TDO          | J3:5   |  GPIO        | DEBUGGER                      |                  |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_27 | 133 | GPIO_6       | GPIO_6_JTAG_TRST_L      | C2  | GPIO_6_JTAG_TRST_L       | J3:1   |  GPIO        | DEBUGGER                      |                  |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_28 | 153 | I2S_MCLK0    | I2S0_MCK                | B36 | I2S0_MCK                 | J6:3   |  I2S, GPIO   |                               | WICED_I2S_1/2    |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_29 | 154 | I2S_SCLK0    | I2S0_SCK_BCLK           | B35 | I2S0_SCK_BCLK            | J6:5   |  I2S, GPIO   |                               | WICED_I2S_1/2    |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_30 | 163 | I2S_LRCLK0   | I2S0_WS_LRCLK           | A51 | I2S0_WS_LRCLK            | J6:6   |  I2S, GPIO   |                               | WICED_I2S_1/2    |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_31 | 164 | I2S_SDATAI0  | I2S0_SD_IN              | A50 | I2S0_SD_IN               | J10:8  |  I2S, GPIO   | ARD_GPIO7                     | WICED_I2S_1/2    |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_32 | 161 | I2S_SDATAO0  | I2S0_SD_OUT             | A48 | I2S0_SD_OUT              | J6:4   |  I2S, GPIO   |                               | WICED_I2S_1/2    |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_33 | 158 | I2S_MCLK1    | I2S1_MCK                | D5  | I2S1_MCK                 | J6:26  |  I2S, GPIO   |                               | WICED_I2S_3/4    |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_34 | 160 | I2S_SCLK1    | I2S1_SCK_BCLK           | B1  | I2S1_SCK_BCLK            | J6:29  |  I2S, GPIO   |                               | WICED_I2S_3/4    |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_35 | 162 | I2S_LRCLK1   | I2S1_WS_LRCLK           | A49 | I2S1_WS_LRCLK            | J6:27  |  I2S, GPIO   |                               | WICED_I2S_3/4    |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_36 | 156 | I2S_SDATAI1  | I2S1_SD_IN              | B38 | I2S1_SD_IN               | J12:1  |  I2S, GPIO   | ARD_GPIO8                     | WICED_I2S_3/4    |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_37 | 155 | I2S_SDATAO1  | I2S1_SD_OUT             | B37 | I2S1_SD_OUT              | J6:10  |  I2S, GPIO   |                               | WICED_I2S_3/4    |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_38 | 83  | SPI_1_CLK    | SPI_1_CLK               | B32 | SPI_1_CLK                | J6:9   |  SPI         |                               | WICED_SPI_2      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_39 | 84  | SPI_1_MISO   | SPI_1_MISO              | B31 | SPI_1_MISO               | J6:11  |  SPI         |                               | WICED_SPI_2      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_40 | 86  | SPI_1_MOSI   | SPI_1_MOSI              | B30 | SPI_1_MOSI               | J6:13  |  SPI         |                               | WICED_SPI_2      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_41 | 80  | SPI_1_CS     | SPI_1_CS                | B33 | SPI_1_CS                 | J6:15  |  SPI         |                               | WICED_SPI_2      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_42 | 152 | SDIO_CLK     | SDIO_CLK                | B25 | SDIO_CLK                 | J6:32  |  SDIO        | uSD Connector/Slot            |                  |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_43 | 151 | SDIO_CMD     | SDIO_CMD                | B24 | SDIO_CMD                 | J6:33  |  SDIO        | uSD Connector/Slot            |                  |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_44 | 150 | SDIO_DATA0   | SDIO_DATA0              | B23 | SDIO_DATA_0              | J6:31  |  SDIO        | uSD Connector/Slot            |                  |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_45 | 149 | SDIO_DATA1   | SDIO_DATA1              | B22 | SDIO_DATA_1              | J6:30  |  SDIO        | uSD Connector/Slot            |                  |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_46 | 148 | SDIO_DATA2   | SDIO_DATA2              | B21 | SDIO_DATA_2              | J6:35  |  SDIO        | uSD Connector/Slot            |                  |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_47 | 147 | SDIO_DATA3   | SDIO_DATA3              | B27 | SDIO_DATA_3              | J6:34  |  SDIO        | uSD Connector/Slot            |                  |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_48 | 93  | I2C0_SDATA   | I2C_0_SDA               | A46 | I2C_0_SDA                | J6:25  |  I2C, GPIO   | External ADC / Auth chip      | WICED_I2C_1      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_49 | 92  | I2C0_CLK     | I2C_0_SCL               | A47 | I2C_0_SCL                | J6:23  |  I2C, GPIO   | External ADC / Auth chip      | WICED_I2C_1      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+------- +--------------+-------------------------------|------------------|
| WICED_GPIO_50 | 90  | I2C1_SDATA   | I2C_1_SDA               | C1  | I2C_1_SDA                | J12:9  |  I2C         |                               | WICED_I2C_2      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
| WICED_GPIO_51 | 89  | I2C1_CLK     | I2C_1_SCL               | B2  | I2C_1_SCL                | J12:10 |  I2C         |                               | WICED_I2C_2      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
|               |     |              |                         |     |                          | J13:1  |  ADC         |                               | WICED_ADC_1      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
|               |     |              |                         |     |                          | J13:2  |  ADC         |                               | WICED_ADC_2      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
|               |     |              |                         |     |                          | J13:3  |  ADC         |                               | WICED_ADC_3      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
|               |     |              |                         |     |                          | J13:4  |  ADC         |                               | WICED_ADC_4      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
|               |     |              |                         |     |                          | J13:5  |  ADC         |                               | WICED_ADC_5      |
|---------------+-----+--------------+-------------------------+-----+--------------------------+--------+--------------+-------------------------------|------------------|
|               |     |              |                         |     |                          | J13:6  |  ADC         |                               | WICED_ADC_6      |
+-------------------------------------------------------------------------------------------------------------------------------------------------------+------------------+
