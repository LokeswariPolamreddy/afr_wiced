 ...
 *
 * $Id: sbusbd.h 324140 2012-03-28 03:04:03Z sgsiener $
 */
...
typedef volatile struct {
    ...
    uint32 workaround;              /* WorkAround 0x1e4 */
    uint32 PAD[6];
...
#define I_ERRORS        (I_PC | I_PD | I_DE | I_RO | I_XU) //(I_PC | I_PD | I_DE | I_RU | I_RO | I_XU) /* #USBDevice#: Ignore I_RU to handle burst TR from host issue!!! */
...
/* workaround register */
#define USB20D_WAR_DISABLE_HW_ZLP           (1L << 1)
